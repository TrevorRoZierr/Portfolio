...
const Certificate = ({ desc, title, link }: CertificateProps) => {
  return (
    <div className="flex gap-y-3 bg-gradient-to-tr from-red-600 to-purple-800 flex-col justify-center items-center text-center p-4 shadow-[0.45rem_0.45rem_10px_0px_rgba(0,0,0,1)] border-2 border-black rounded-lg">
